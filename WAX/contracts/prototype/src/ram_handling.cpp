...
*/
ACTION redeemprtcol::withdrawram(
...
* and inline actions
*/
ACTION redeemprtcol::buyramproxy(
...
*/
void redeemprtcol::increase_collection_ram_balance(
    name collection_name,
    int64_t bytes
) {
...
*/
void redeemprtcol::decrease_collection_ram_balance(
    name collection_name,
    int64_t bytes,
...
* Throws if the collection does not have enough balance
*/
void redeemprtcol::test_collection_ram_balance(
    name collection_name,
    int64_t bytes,
    string error_message
) {
